...
import com.ruoyi.system.domain.BaseRepairRecord;
 ...
 */
@RestController
@RequestMapping("/system/reprecord")
public class BaseRepairRecordController extends BaseController
{
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, BaseRepairRecord baseRepairRecord)
    {
        List<BaseRepairRecord> list = baseRepairRecordService.selectBaseRepairRecordList(baseRepairRecord);
    ...
    {
        return success(baseRepairRecordService.selectBaseRepairRecordById(id));
    }
