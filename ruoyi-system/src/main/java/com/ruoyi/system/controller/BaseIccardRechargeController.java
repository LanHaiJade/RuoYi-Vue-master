...
import com.ruoyi.system.domain.BaseIccardRecharge;
...
public class BaseIccardRechargeController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo list(BaseIccardRecharge baseIccardRecharge)
    {
        startPage();
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, BaseIccardRecharge baseIccardRecharge)
    {
        List<BaseIccardRecharge> list = baseIccardRechargeService.selectBaseIccardRechargeList(baseIccardRecharge);
        ExcelUtil<BaseIccardRecharge> util = new ExcelUtil<BaseIccardRecharge>(BaseIccardRecharge.class);
